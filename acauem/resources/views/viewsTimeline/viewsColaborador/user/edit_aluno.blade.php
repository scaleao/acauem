...
@section('conteudo')
    <div class="row justify-content-end mr-5 mb-2">
        <a href="{{route('aluno.destroy', $dados->id)}}" class="btn btn-danger"><img src="../storage/rubbish-bin.png" style="width: 25px; height: 25px;">DELETAR USUARIO</a>
    </div>
    <div class="row">
        <div class="container border border-secondary">
            ...
            @endif
            <form action="{{route('aluno.update', $dados->id)}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="validationTooltipUsername" name="rg" placeholder="00.000.000-00" value="{{isset($dados->rg) ? $dados->rg : ''}}" aria-describedby="validationTooltipUsernamePrepend">
                        </div>
                        @error('rg')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationDefault09">Responsavel (Mãe, Pai, Tios ou Avós)</label>
                        <input type="text" class="form-control" id="validationDefault09" name="responsavel" placeholder="Maria Elena Aparecida" value="{{isset($dados->responsavel) ? $dados->responsavel : ''}}">
                        @error('responsavel')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="validationDefault10">RG (Responsavel)</label>
                        <input type="text" class="form-control" id="validationDefault10" name="rg_responsavel" placeholder="00.000.000-00" value="{{isset($dados->rg_responsavel) ? $dados->rg_responsavel : ''}}">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="fone" placeholder="(00) 00000-0000" value="{{isset($dados->fone) ? $dados->fone : ''}}" id="validationDefault11">
                        @error('fone')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
